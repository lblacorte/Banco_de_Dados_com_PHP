			...
			<table border="0" align=center class="cabeçalho" style="border-collapse: collapse">
				<tr>
					<style type="text/css">
						...
						<td colspan="9">
							<a href="">
								<img src="https://i.ibb.co/qM3wVvy/Cabe-alho-programa-o.jpg">
							</a>
						</td>
				</tr>
				<tr 
					...
					<td align="center" 
						...
						width: 1010px">
							<FONT
								...
								color: white; 
								font-size: 11pt">
									<n>Inserir dados em uma tabela de banco de dados | Leandro Lacorte - Info 2B | (55) 9 9694 9865 | Copyright © 2021 - IFFar - Campus Júlio de Castilhos - Curso Técnico Integrado em Informática - v1.0</n>
					</td>
				</tr>
				<br>
				<br>
